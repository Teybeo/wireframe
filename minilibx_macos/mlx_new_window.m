...
- (void) setRelativeMouseMode:(int)mode
{
  relative_mode = mode;
}
...
- (void) mouseMoved:(NSEvent *)theEvent
{
  ...
  thepoint = [theEvent locationInWindow];
  thepoint.y = size_y - 1 - thepoint.y;
...
void    mlx_set_relative_mouse_mode(mlx_win_list_t *win, int mode)
{
	[(id)(win->winid) setRelativeMouseMode:mode];
}